    ...
    try:
        ...
        # User is logged in
            ...
            if request.method == 'POST':
                ...
                if not form.is_valid():
                    error = "Invalid inputs"
                    return render(request, 'achievement/new_article.html', \
                                              {'form': form, \
                                               'error': error, \
                                               'is_loggedin': is_loggedin, \
                                               'username': username}, \
    ...
    try:
        ...
        # User is logged in
            ...
            if request.method == 'POST':
                ...
                if not form.is_valid():
                    error = "Invalid inputs"
                    return render(request, 'achievement/new_speaker.html', \
                                              {'form': form, \
                                               'error': error, \
                                               'is_loggedin': is_loggedin, \
                                               'username': username}, \
    ...
    try:
        ...
        # User is logged in
            ...
            if request.method == 'POST':
                ...
                if not form.is_valid():
                    error = "Invalid inputs"
                    return render(request, 'achievement/new_gsoc.html', \
                                              {'form': form, \
                                               'error': error, \
                                               'is_loggedin': is_loggedin, \
                                               'username': username}, \
    ...
    try:
        ...
        # User is logged in
            ...
            if request.method == 'POST':
                ...
                if not form.is_valid():
                    error = "Invalid inputs"
                    return render(request, 'achievement/new_intern.html', \
                                              {'form': form, \
                                               'error': error, \
                                               'is_loggedin': is_loggedin, \
                                               'username': username}, \
